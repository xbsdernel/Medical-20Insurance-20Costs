import { ArrowRight, Heart, FileText, BarChart3, Zap, Github, Linkedin, Twitter } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="sticky top-0 z-50 border-b border-border/50 bg-background/95 backdrop-blur-sm">
        <nav className="container mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-lg text-foreground">MediCost Predict</span>
          </div>
          <div className="hidden md:flex items-center gap-8">
            ...
            <a href="#demo" className="text-sm text-muted-foreground hover:text-foreground smooth-transition">Try It</a>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-foreground mb-6 leading-tight">
              Predict Your Medical Insurance Costs <span className="gradient-text">Instantly</span>
            </h1>

            <p className="text-lg sm:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
              Use AI to estimate your medical insurance costs based on your personal health profile. Get accurate predictions in seconds.
            </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground">Understand your medical insurance costs with machine learning</p>
            </div>

            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <p className="text-lg text-muted-foreground leading-relaxed">
                  This project uses advanced machine learning algorithms to predict your medical insurance costs based on your personal health profile and demographic information.
                </p>
                <p className="text-lg text-muted-foreground leading-relaxed">
                  By analyzing factors like age, BMI, smoking habits, and region, our AI model provides accurate cost estimates to help you plan your healthcare budget better.
                </p>
                ...
                <div className="space-y-4 pt-4">
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-foreground mb-1">Fast Predictions</h3>
                      <p className="text-muted-foreground">Get instant estimates in less than a second</p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Simple interface with clear input fields</p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    <BarChart3 className="w-6 h-6 text-primary flex-shrink-0 mt-1" />
                    <div>
                      <h3 className="font-semibold text-foreground mb-1">Accurate Models</h3>
                      <p className="text-muted-foreground">Built on real ML algorithms trained on actual data</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section id="how-it-works" className="py-20 sm:py-32 bg-gradient-to-b from-background to-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-foreground mb-4">3 Simple Steps</h2>
              <p className="text-lg text-muted-foreground">Get your medical insurance cost prediction in minutes</p>
            </div>
              ...
              {[
                {
                  ...
                  description: 'Input your personal information including age, sex, BMI, smoking status, and region',
                  icon: FileText,
                },
                {
                  step: 2,
                  title: 'Click Predict',
                  description: 'Our AI analyzes your profile and generates a personalized cost prediction',
                  icon: Zap,
                },
                {
                  step: 3,
                  title: 'Get Results',
                  description: 'Receive your estimated medical insurance cost instantly and plan accordingly',
                  icon: BarChart3,
                },
              ].map((item) => {
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-foreground mb-4">Try It Now</h2>
              <p className="text-lg text-muted-foreground">Use our interactive app to get your personalized prediction</p>
            </div>
            ...
            <div className="mt-8 text-center">
              <p className="text-sm text-muted-foreground">
                Update the iframe URL above with your live Streamlit app link once it's deployed
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 sm:py-32 bg-gradient-to-r from-primary/5 to-secondary/5">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-6">Ready to Predict Your Costs?</h2>
            <p className="text-lg text-muted-foreground mb-8">
              Get an accurate estimate of your medical insurance costs in seconds. No credit card required.
            </p>
            <a 
              href="#demo" 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div>
              ...
              <p className="text-background/70 text-sm">
                AI-powered medical insurance cost prediction for better healthcare planning.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-sm text-background/70">
                ...
                <li><a href="#demo" className="hover:text-background smooth-transition">Try It</a></li>
